                ...
                <View style={{ paddingTop: hp(8), paddingHorizontal: wp(5), flex:1 }} className="gap-12">
                    ...
                    <View style={{ rowGap: hp(2), flex:1 }}>
                        ...
                        <View style={{ flexDirection: "row", height: hp(7), backgroundColor: "whitesmoke", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                            ...
                            <TextInput style={{ flex:1, fontSize: hp(2) }} onChangeText={val => input.current.email = val} className="flex-1 font-semibold text-neutral-500" placeholder='Email' placeholderTextColor={'gray'} />
                        </View>
                        <View style={{ flexDirection: "row", height: hp(7), backgroundColor: "whitesmoke", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                            <View style={{ width: wp(10), alignItems: "center" }}>
                                <Octicons name="lock" size={24} color="gray" />
                            </View>
                            <TextInput style={{ flex:1, fontSize: hp(2) }} onChangeText={val => input.current.password = val} className="flex-1 font-semibold text-neutral-500" placeholder='Password' placeholderTextColor={'gray'} secureTextEntry={form.password} />
                        ...
                        <View style={{flex:1}}>
                            {form.loading ?
                                ...
                                :
                                <View>
                                    <TouchableOpacity onPress={handleLogin} style={{ justifyContent: "center", alignItems: "center", height: hp(7), backgroundColor: COLORS.TEAL, borderRadius:20 }}>
