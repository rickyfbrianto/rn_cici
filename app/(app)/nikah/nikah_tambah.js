...
const NikahTambah = () => {
    const { control, reset, handleSubmit, clearErrors, setValue, formState: { errors, isSubmitting } } = useForm({
        defaultValues: {
            pria: null, tempat_lahir_pria: null, tanggal_lahir_pria: null, gereja_pria: null, alamat_pria: null,
            wanita: null, tempat_lahir_wanita: null, tanggal_lahir_wanita: null, gereja_wanita: null, alamat_wanita: null,
            saksi: null, hari: null, tanggal: null, jam: null, pdt: null, lokasi: null
        }
    })
        ...
        <CustomKeyboard>
            <ScrollView>
                <View style={{ padding: 20, rowGap: 10 }} >
                    <Text style={{ fontFamily: "outfit-bold", fontSize: hp(2.4) }} className="font-bold text-neutral-500">Masukkan jadwal nikah</Text>
                    ...
                    <View style={{ flexDirection: "row", borderWidth: errors.tempat_lahir_pria ? 2 : 0, borderColor: "red", height: hp(7), backgroundColor: "white", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                        ...
                        <Controller control={control} name='tempat_lahir_pria' rules={{ required: { value: true } }} render={({ field: { onChange, value, onBlur } }) => (
                            <TextInput style={{ flex: 1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" placeholder='Tempat Lahir Pria' placeholderTextColor={'gray'} />
                        )} />
                        {errors?.tempat_lahir_pria && <FontAwesome name="exclamation" size={24} color="red" />}
                    </View>
                    <Pressable onPress={() => setDTPicker(prev => ({ ...prev, tanggal_lahir_pria: true }))} className={`flex flex-row bg-white items-center`}
                        style={{ borderWidth: errors.tanggal_lahir_pria ? 2 : 0, borderColor: "red", height: hp(7), borderRadius: 15, paddingHorizontal: hp(2), columnGap: wp(2) }}>
                        <View style={{ width: wp(10), alignItems: "center" }}>
                        ...
                        <Controller control={control} name='tanggal_lahir_pria' rules={{ required: { value: true } }} render={({ field }) => (
                            <View className="flex-1">
                                ...
                                <TextInput style={{ fontSize: hp(2) }} value={field.value} onChangeText={v => field.onChange(v)} className="flex-1 w-full font-semibold text-neutral-500"
                                    placeholder='Tanggal Lahir Pria' placeholderTextColor={'gray'} />
                            </View>
                        )} />
                    ...
                    <View style={{ flexDirection: "row", borderWidth: errors.gereja_pria ? 2 : 0, borderColor: "red", height: hp(7), backgroundColor: "white", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                        ...
                        <Controller control={control} name='gereja_pria' rules={{ required: { value: true } }} render={({ field: { onChange, value, onBlur } }) => (
                            <TextInput style={{ flex: 1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" placeholder='Gereja Pria' placeholderTextColor={'gray'} />
                        )} />
                    ...
                    <View style={{ flexDirection: "row", borderWidth: errors.alamat_pria ? 2 : 0, borderColor: "red", height: hp(7), backgroundColor: "white", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                        ...
                        <Controller control={control} name='alamat_pria' rules={{ required: { value: true } }} render={({ field: { onChange, value, onBlur } }) => (
                            <TextInput style={{ flex: 1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" placeholder='Alamat Pria' placeholderTextColor={'gray'} />
                        )} />
                    ...
                    <View style={{ flexDirection: "row", borderWidth: errors.tempat_lahir_wanita ? 2 : 0, borderColor: "red", height: hp(7), backgroundColor: "white", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                        ...
                        <Controller control={control} name='tempat_lahir_wanita' rules={{ required: { value: true } }} render={({ field: { onChange, value, onBlur } }) => (
                            <TextInput style={{ flex: 1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" placeholder='Tempat Lahir Wanita' placeholderTextColor={'gray'} />
                        )} />
                        {errors?.tempat_lahir_wanita && <FontAwesome name="exclamation" size={24} color="red" />}
                    </View>
                    <Pressable onPress={() => setDTPicker(prev => ({ ...prev, tanggal_lahir_wanita: true }))} className={`flex flex-row bg-white items-center`}
                        style={{ borderWidth: errors.tanggal_lahir_wanita ? 2 : 0, borderColor: "red", height: hp(7), borderRadius: 15, paddingHorizontal: hp(2), columnGap: wp(2) }}>
                        <View style={{ width: wp(10), alignItems: "center" }}>
                            <FontAwesome name="calendar-o" size={24} color="gray" />
                        </View>
                        <Controller control={control} name='tanggal_lahir_wanita' rules={{ required: { value: true } }} render={({ field }) => (
                            <View className="flex-1">
                                {DTPicker.tanggal_lahir_wanita && <DateTimePicker mode='date' value={new Date()} display='default' onChange={handleTanggalLahirWanita} />}
                                <TextInput style={{ fontSize: hp(2) }} value={field.value} onChangeText={v => field.onChange(v)} className="flex-1 w-full font-semibold text-neutral-500"
                                    placeholder='Tanggal Lahir Wanita' placeholderTextColor={'gray'} />
                            </View>
                        )} />
                    ...
                    <View style={{ flexDirection: "row", borderWidth: errors.gereja_wanita ? 2 : 0, borderColor: "red", height: hp(7), backgroundColor: "white", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                        ...
                        <Controller control={control} name='gereja_wanita' rules={{ required: { value: true } }} render={({ field: { onChange, value, onBlur } }) => (
                            <TextInput style={{ flex: 1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" placeholder='Gereja Wanita' placeholderTextColor={'gray'} />
                        )} />
                    ...
                    <View style={{ flexDirection: "row", borderWidth: errors.alamat_wanita ? 2 : 0, borderColor: "red", height: hp(7), backgroundColor: "white", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                        ...
                        <Controller control={control} name='alamat_wanita' rules={{ required: { value: true } }} render={({ field: { onChange, value, onBlur } }) => (
                            <TextInput style={{ flex: 1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" placeholder='Alamat Wanita' placeholderTextColor={'gray'} />
                        )} />
                    ...
                    <View style={{ flexDirection: "row", borderWidth: errors.saksi ? 2 : 0, borderColor: "red", height: hp(7), backgroundColor: "white", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                        ...
                        <Controller control={control} name='saksi' rules={{ required: { value: true } }} render={({ field: { onChange, value, onBlur } }) => (
                            <TextInput style={{ flex: 1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" placeholder='Saksi' placeholderTextColor={'gray'} />
                        )} />
