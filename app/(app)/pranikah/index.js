...
import PraNikahCard from '../../../components/CardPraNikah';
        ...
        <>
            <View style={{ justifyContent: "flex-end", paddingTop: top, paddingBottom: hp(3), height: hp(20), borderBottomLeftRadius: 50, backgroundColor: colorBase, paddingHorizontal: wp(5) }}>
                <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <Text style={{ fontFamily: "outfit", fontSize: hp(3), fontWeight: "bold", color: "white" }}>Pra Nikah</Text>
                </View>
            </View>
            {/* Body */}
            <View style={{ padding: 10, flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                    <PraNikahCard style={{ backgroundColor: colorBase }} showControl={true} />
                </View>
            </View>
            {user && user?.level == "admin" &&
                <SpeedDial
                    ...
                    <SpeedDial.Action color={colorBase} icon={{ name: 'add', color: '#fff' }} title="Pranikah" onPress={() => router.push('pranikah/pranikah_tambah')} />
                </SpeedDial>
            }
        </>
    )
