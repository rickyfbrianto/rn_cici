...
const IbadahDetail = () => {
    ...
    return (
        <ScrollView nestedScrollEnabled refreshControl={<RefreshControl refreshing={refresh} onRefresh={handleRefresh} />} style={{ flex: 1, backgroundColor: "white" }}>
            <View style={{ backgroundColor: colorBase, flex: 1 }}>
                ...
                {dataQuery.isLoading
                    ? <Text>Loading...</Text>
                    : <View className="flex-1 items-center bg-white" style={{ borderTopLeftRadius: hp(6), flex: 1, borderTopRightRadius: hp(6), marginTop: 100, paddingBottom: 20, }}>
                        ...
                        <View className="flex-1 justify-center" style={{ marginTop: hp(2), width: "100%", paddingHorizontal: hp(2) }}>
                            ...
                            <View style={{ flexDirection: "row", alignItems: "center", borderBottomWidth: 1, borderBottomColor: colorBase, columnGap: hp(2), marginHorizontal: hp(1), paddingHorizontal: hp(1), paddingVertical: hp(1.4) }}>
                                ...
                                <Text style={{fontSize:hp(1.8)}}>{dataQuery.data.hari}</Text>
                            </View>
                            <View style={{ flexDirection: "row", alignItems: "center", borderBottomWidth: 1, borderBottomColor: colorBase, columnGap: hp(2), marginHorizontal: hp(1), paddingHorizontal: hp(1), paddingVertical: hp(1.4) }}>
                                <View style={{ flexDirection: "row", justifyContent: "center", width: 30 }}>
                            ...
                            {dataQuery.data.wl[0] && 
                                <View style={{ borderBottomWidth: 1, borderBottomColor: colorBase, marginHorizontal: hp(1), paddingHorizontal: hp(1), paddingVertical: hp(1.4) }}>
                                    ...
                                    <FlatList data={dataQuery.data.wl} numColumns={2} contentContainerStyle={{rowGap:10, display:"flex"}} columnWrapperStyle={{columnGap:10}} renderItem={({item, index})=>(
                            ...
                            {dataQuery.data.singer[0] && 
                                <View style={{ borderBottomWidth: 1, borderBottomColor: colorBase, marginHorizontal: hp(1), paddingHorizontal: hp(1), paddingVertical: hp(1.4) }}>
                                    ...
                                    <FlatList data={dataQuery.data.singer} numColumns={2} contentContainerStyle={{rowGap:10, display:"flex"}} columnWrapperStyle={{columnGap:10}} renderItem={({item, index})=>(
                                        <View style={{flex:1, paddingHorizontal:10, paddingVertical:6, backgroundColor:"whitesmoke"}}>
                                            <Text>{index+1 + ". " + item.value}</Text>
                                        </View>
                                    )}/>
                            ...
                            <View style={{ borderBottomWidth: 1, borderBottomColor: colorBase, marginHorizontal: hp(1), paddingHorizontal: hp(1), paddingVertical: hp(1.4) }}>
                                ...
                                <FlatList data={dataQuery.data.musik} numColumns={2} contentContainerStyle={{rowGap:10, display:"flex"}} columnWrapperStyle={{columnGap:10}} renderItem={({item, index})=>(
                                    <View style={{flex:1, paddingHorizontal:10, paddingVertical:6, backgroundColor:"whitesmoke"}}>
                                        <Text>{index+1 + ". " + item.value}</Text>
                                    </View>
                                )}/>
                            ...
                            {dataQuery.data.mm[0] && 
                                <View style={{ borderBottomWidth: 1, borderBottomColor: colorBase, marginHorizontal: hp(1), paddingHorizontal: hp(1), paddingVertical: hp(1.4) }}>
                                    ...
                                    <FlatList data={dataQuery.data.mm} numColumns={2} contentContainerStyle={{rowGap:10, display:"flex"}} columnWrapperStyle={{columnGap:10}} renderItem={({item, index})=>(
                                        <View style={{flex:1, paddingHorizontal:10, paddingVertical:6, backgroundColor:"whitesmoke"}}>
                                            <Text>{index+1 + ". " + item.value}</Text>
                                        </View>
                                    )}/>
                            ...
                            {dataQuery.data.protokoler[0] && 
                                <View style={{ borderBottomWidth: 1, borderBottomColor: colorBase, marginHorizontal: hp(1), paddingHorizontal: hp(1), paddingVertical: hp(1.4) }}>
                                    ...
                                    <FlatList data={dataQuery.data.protokoler} numColumns={2} contentContainerStyle={{rowGap:10, display:"flex"}} columnWrapperStyle={{columnGap:10}} renderItem={({item, index})=>(
                                        <View style={{flex:1, paddingHorizontal:10, paddingVertical:6, backgroundColor:"whitesmoke"}}>
                                            <Text>{index+1 + ". " + item.value}</Text>
                                        </View>
                                    )}/>
                            ...
                            {dataQuery.data.tbf[0] && 
                                <View style={{ borderBottomWidth: 1, borderBottomColor: colorBase, marginHorizontal: hp(1), paddingHorizontal: hp(1), paddingVertical: hp(1.4) }}>
                                    ...
                                    <FlatList data={dataQuery.data.tbf} numColumns={2} contentContainerStyle={{rowGap:10, display:"flex"}} columnWrapperStyle={{columnGap:10}} renderItem={({item, index})=>(
                                        <View style={{flex:1, paddingHorizontal:10, paddingVertical:6, backgroundColor:"whitesmoke"}}>
                                            <Text>{index+1 + ". " + item.value}</Text>
                                        </View>
                                    )}/>
