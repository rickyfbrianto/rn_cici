...
const IbadahTambah = () => {
    const form = useForm({
        defaultValues:{
            ...
            wl: [{value:"tes"}], singer: [{value:""}], musik: [{value:""}], mm: [{value:""}], protokoler: [{value:""}], tbf: [{value:""}],
        }
    })
            ...
            <ScrollView>
                <View style={{padding:20, rowGap:10}} >
                    ...
                    <View style={{ flexDirection:"row", borderWidth: form.formState.errors.judul ? 2 : 0, borderColor:"red", height: hp(7), backgroundColor:"white", borderRadius:15, paddingHorizontal:hp(2), alignItems:"center", columnGap:wp(2) }}>
                        ...
                        <Controller control={form.control} name='judul' rules={{required:{value:true}}} render={({field:{onChange, value, onBlur}}) => (
                    ...
                    <Pressable onPress={() => setDTPicker(prev => ({ ...prev, tanggal: true }))} style={{ flexDirection: "row", borderWidth: form.formState.errors.tanggal ? 2 : 0, borderColor: "red", height: hp(7), backgroundColor: "white", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                        ...
                        <Controller control={form.control} name='hari' rules={{ required: { value: true } }} render={({ field }) => (
                        ...
                        <Controller control={form.control} name='tanggal' rules={{ required: { value: true } }} render={({ field }) => (
                            <View>
                    ...
                    <Pressable onPress={() => setDTPicker(prev => ({ ...prev, jam: true }))} style={{ flexDirection: "row", borderWidth: form.formState.errors.jam ? 2 : 0, borderColor: "red", height: hp(7), backgroundColor: "white", borderRadius: 15, paddingHorizontal: hp(2), alignItems: "center", columnGap: wp(2) }}>
                        ...
                        <Controller control={form.control} name='jam' rules={{ required: { value: true } }} render={({ field: { onChange, value } }) => (
                            <View>
                    ...
                    <View style={{ flexDirection:"row", borderWidth: form.formState.errors.pdt ? 2 : 0, borderColor:"red", height: hp(7), backgroundColor:"white", borderRadius:15, paddingHorizontal:hp(2), alignItems:"center", columnGap:wp(2) }}>
                        ...
                        <Controller control={form.control} name='pdt' rules={{required:{value:true}}} render={({field:{onChange, value, onBlur}}) => (
                    ...
                    <View style={{ flexDirection:"row", borderWidth: form.formState.errors.lokasi ? 2 : 0, borderColor:"red", height: hp(7), backgroundColor:"white", borderRadius:15, paddingHorizontal:hp(2), alignItems:"center", columnGap:wp(2) }}>
                        ...
                        <Controller control={form.control} name='lokasi' rules={{required:{value:true}}} render={({field:{onChange, value, onBlur}}) => (
                    ...
                    {wl.fields.map((v, index) => {
                        ...
                        return (
                            <View key={v.id} style={{ flexDirection:"row", borderColor:"red", height: hp(7), backgroundColor:"white", borderRadius:15, paddingHorizontal:hp(2), alignItems:"center", columnGap:wp(2) }}>
                                ...
                                <Controller control={form.control} name={`wl.${index}.value`} rules={{required:true}} render={({field:{onChange, value, onBlur}}) => (
                                    <TextInput style={{ flex:1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" 
                                    placeholder={`Worship Leader ${index+1}`} placeholderTextColor={'gray'} />
                                )}/>
                                {index == len &&
                                    <TouchableOpacity onPress={() => {wl.append({ value: ""})}}>
                    ...
                    {singer.fields?.map((v, index) => {
                        ...
                        return (
                            <View key={v.id} style={{ flexDirection:"row", borderColor:"red", height: hp(7), backgroundColor:"white", borderRadius:15, paddingHorizontal:hp(2), alignItems:"center", columnGap:wp(2) }}>
                                ...
                                <Controller control={form.control} name={`singer.${index}.value`} rules={{required:{value:true}}} render={({field:{onChange, value, onBlur}}) => (
                                    <TextInput style={{ flex:1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" 
                                    placeholder={`Singer ${index+1}`} placeholderTextColor={'gray'} />
                                )}/>
                                {index == len &&
                                    <TouchableOpacity onPress={() => {singer.append({ value: ""})}}>
                                        <AntDesign name="pluscircle" size={24} color="green" />
                                    </TouchableOpacity>
                                }
                                {(len > 0) && 
                                    <TouchableOpacity onPress={() => {singer.remove(index)}}>
                                        <AntDesign name="minuscircle" size={24} color="red" />
                                    </TouchableOpacity>
                                }
                            </View>
                    ...
                    {musik.fields?.map((v, index) => {
                        ...
                        return (
                            <View key={v.id} style={{ flexDirection:"row", borderColor:"red", height: hp(7), backgroundColor:"white", borderRadius:15, paddingHorizontal:hp(2), alignItems:"center", columnGap:wp(2) }}>
                                ...
                                <Controller control={form.control} name={`musik.${index}.value`} rules={{required:{value:true}}} render={({field:{onChange, value, onBlur}}) => (
                                    <TextInput style={{ flex:1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" 
                                    placeholder={`Musik ${index+1}`}  placeholderTextColor={'gray'} />
                                )}/>
                                {index == len &&
                                    <TouchableOpacity onPress={() => {musik.append({ value: ""})}}>
                                        <AntDesign name="pluscircle" size={24} color="green" />
                                    </TouchableOpacity>
                                }
                                {(len > 0) && 
                                    <TouchableOpacity onPress={() => {musik.remove(index)}}>
                                        <AntDesign name="minuscircle" size={24} color="red" />
                                    </TouchableOpacity>
                                }
                            </View>
                    ...
                    {mm.fields?.map((v, index) => {
                        ...
                        return (
                            <View key={v.id} style={{ flexDirection:"row", borderColor:"red", height: hp(7), backgroundColor:"white", borderRadius:15, paddingHorizontal:hp(2), alignItems:"center", columnGap:wp(2) }}>
                                ...
                                <Controller control={form.control} name={`mm.${index}.value`} rules={{required:{value:true}}} render={({field:{onChange, value, onBlur}}) => (
                                    <TextInput style={{ flex:1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" 
                                    placeholder={`Multimedia ${index+1}`} placeholderTextColor={'gray'} />
                                )}/>
                                {index == len &&
                                    <TouchableOpacity onPress={() => {mm.append({ value: ""})}}>
                                        <AntDesign name="pluscircle" size={24} color="green" />
                                    </TouchableOpacity>
                                }
                                {(len > 0) && 
                                    <TouchableOpacity onPress={() => {mm.remove(index)}}>
                                        <AntDesign name="minuscircle" size={24} color="red" />
                                    </TouchableOpacity>
                                }
                            </View>
                    ...
                    {protokoler.fields?.map((v, index) => {
                        ...
                        return (
                            <View key={v.id} style={{ flexDirection:"row", borderColor:"red", height: hp(7), backgroundColor:"white", borderRadius:15, paddingHorizontal:hp(2), alignItems:"center", columnGap:wp(2) }}>
                                ...
                                <Controller control={form.control} name={`protokoler.${index}.value`} rules={{required:{value:true}}} render={({field:{onChange, value, onBlur}}) => (
                                    <TextInput style={{ flex:1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" 
                                    placeholder={`Protokoler ${index+1}`} placeholderTextColor={'gray'} />
                                )}/>
                                {index == len &&
                                    <TouchableOpacity onPress={() => {protokoler.append({ value: ""})}}>
                                        <AntDesign name="pluscircle" size={24} color="green" />
                                    </TouchableOpacity>
                                }
                                {(len > 0) && 
                                    <TouchableOpacity onPress={() => {protokoler.remove(index)}}>
                                        <AntDesign name="minuscircle" size={24} color="red" />
                                    </TouchableOpacity>
                                }
                            </View>
                    ...
                    {tbf.fields?.map((v, index) => {
                        ...
                        return (
                            <View key={v.id} style={{ flexDirection:"row", borderColor:"red", height: hp(7), backgroundColor:"white", borderRadius:15, paddingHorizontal:hp(2), alignItems:"center", columnGap:wp(2) }}>
                                ...
                                <Controller control={form.control} name={`tbf.${index}.value`} rules={{required:{value:true}}} render={({field:{onChange, value, onBlur}}) => (
                                    <TextInput style={{ flex:1, fontSize: hp(2) }} value={value} onBlur={onBlur} onChangeText={val => onChange(val)} className="flex-1 font-semibold text-neutral-500" 
                                    placeholder={`TBF ${index+1}`} placeholderTextColor={'gray'} />
                                )}/>
                                {index == len &&
                                    <TouchableOpacity onPress={() => {tbf.append({ value: ""})}}>
                                        <AntDesign name="pluscircle" size={24} color="green" />
                                    </TouchableOpacity>
                                }
                                {(len > 0) && 
                                    <TouchableOpacity onPress={() => {tbf.remove(index)}}>
                                        <AntDesign name="minuscircle" size={24} color="red" />
                                    </TouchableOpacity>
                                }
                            </View>
