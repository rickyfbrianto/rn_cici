...
import { Ionicons, Octicons, EvilIcons, AntDesign } from "@expo/vector-icons";
...
const CardItem = ({ item, index, showControl }) => {
	...
	return (
		<Swipeable ref={swipeRef} renderLeftActions={LeftSwipe}>
			<Pressable onPress={() => router.push(`${name}/${item.id}`)} style={{ width: wp(44), columnGap: 5, marginTop: wp(4), borderRadius: 10, backgroundColor: "#edebd7" }}>
